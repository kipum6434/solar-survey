...
function DashboardLayoutContent({
  ...
  const [tcsExpanded, setTcsExpanded] = useState(() => location.startsWith("/tcs/"));
  const [gulfExpanded, setGulfExpanded] = useState(() => location.startsWith("/gulf/"));
  const [meaExpanded, setMeaExpanded] = useState(() => location.startsWith("/mea/"));
            ...
            <SidebarMenu className="flex-shrink-0">
              ...
              <SidebarMenuItem>
                <SidebarMenuButton
                  ...
                  tooltip="งาน TCS"
                  className={`h-10 transition-all font-normal rounded-lg ${location.startsWith("/tcs/") ? "text-amber-600 font-medium" : "text-sidebar-foreground/70 hover:text-sidebar-foreground hover:bg-sidebar-accent/50"}`}
                >
              ...
              <SidebarMenuItem>
                <SidebarMenuButton
                  ...
                  tooltip="Gulf"
                  className={`h-10 transition-all font-normal rounded-lg ${location.startsWith("/gulf/") ? "text-blue-600 font-medium" : "text-sidebar-foreground/70 hover:text-sidebar-foreground hover:bg-sidebar-accent/50"}`}
                >
              ...
              <SidebarMenuItem>
                <SidebarMenuButton
                  ...
                  tooltip="MEA"
                  className={`h-10 transition-all font-normal rounded-lg ${location.startsWith("/mea/") ? "text-green-600 font-medium" : "text-sidebar-foreground/70 hover:text-sidebar-foreground hover:bg-sidebar-accent/50"}`}
                >
