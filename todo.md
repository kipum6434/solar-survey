...
### 6. แก้การ์ดข้อมูลเทคนิคให้แสดงเสมอ
- [x] แก้ให้การ์ดข้อมูลเทคนิคแสดงเสมอแม้ยังไม่มีข้อมูล แสดง "-" สำหรับช่องที่ยังว่าง

### 7. Inline edit การ์ดข้อมูลเทคนิค
- [x] แก้การ์ดข้อมูลเทคนิคให้คลิกแก้ไขได้เลย (inline edit) ไม่ต้องกดปุ่มดินสอขวาบน
- [x] เพิ่มปุ่มบันทึกด้านล่างการ์ดเพื่อยืนยันการแก้ไข

### 8. ให้แก้ไขข้อมูลลูกค้าจากการ์ดเทคนิคได้เลย
- [x] เพิ่มช่องแก้ไขข้อมูลลูกค้า (ค่าไฟ, ประเภทหลังคา, พื้นที่หลังคา, ระบบไฟ, ขนาดมิเตอร์) ใน inline edit mode
- [x] สร้าง/อัพเดท backend API สำหรับ update customer fields จากหน้า survey
- [x] บันทึกข้อมูลลูกค้าพร้อมข้อมูลเทคนิคในปุ่มบันทึกเดียวกัน
