...
- [x] เปลี่ยนจาก jsPDF doc.text() เป็น html2pdf.js (ใช้ browser engine render ภาษาไทย)
- [x] ใช้ฟอนต์ Sarabun ผ่าน Google Fonts CSS @import
- [x] สร้าง HTML layout ที่ตรงกับ A4 (210mm width)
- [x] แก้ปัญหาวรรณยุกต์/สระหาย (ทั้ง, น้ำ, ค่า)
